...
RSpec.describe WikisController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of Wiki by 1" do
      expect{ wiki :create, params: { post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false }}}.to change(Wiki,:count).by(1)
    end
  ...
  describe "DELETE destroy" do
   ...
   it "redirects to wikis index" do
     delete :destroy, params: { id: mywiki.id }
