 ...
 describe "GET index" do
  ...
  describe "POST create" do
    it "increases the number of Wiki by 1" do
      expect{wiki :create, post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false}}.to change(Wiki,:count).by(1)
    end
...
#     it "increases the number of Wiki by 1" do
#       expect { post :create, params: { wiki: { title: 'Wiki Test Title', body: 'Wiki Test Body' }}}.to change(Wiki,:count).by(1)
#     end
    
#     it "assigns the new wiki to @wiki" do
#       post :create, params: { wiki: { title: 'Wiki Test Title', body: 'Wiki Test Body' }}
#       expect(assigns(:wiki)).to eq Wiki.last
#     end
